...
const Slideshow = () => {
  const images = [
    { src: '/glowna/1.webp', alt: 'Zdjęcie 1 - portfolio fotografii' },
    { src: '/glowna/2.webp', alt: 'Zdjęcie 2 - portfolio fotografii' },
    { src: '/glowna/3.webp', alt: 'Zdjęcie 3 - portfolio fotografii' },
    { src: '/glowna/4.webp', alt: 'Zdjęcie 4 - portfolio fotografii' },
    { src: '/glowna/5.webp', alt: 'Zdjęcie 5 - portfolio fotografii' },
    { src: '/glowna/6.webp', alt: 'Zdjęcie 6 - portfolio fotografii' },
    { src: '/glowna/1.webp', alt: 'Zdjęcie 1 - portfolio fotografii' },
    { src: '/glowna/2.webp', alt: 'Zdjęcie 2 - portfolio fotografii' },
    { src: '/glowna/3.webp', alt: 'Zdjęcie 3 - portfolio fotografii' },
    { src: '/glowna/4.webp', alt: 'Zdjęcie 4 - portfolio fotografii' },
